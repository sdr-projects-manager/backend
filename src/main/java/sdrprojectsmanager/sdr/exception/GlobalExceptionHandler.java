...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleBadRequestException(ConstraintViolationException exception, WebRequest request){
    ...
    public ResponseEntity<?> handleEntityException(EntityNotFoundException exception, WebRequest request){
        ErrorDetails errorDetails = new ErrorDetails(new Date(), "Request exception", request.getDescription(false));
        return new ResponseEntity(errorDetails, HttpStatus.NOT_FOUND);
    }
